                    ...
                    <div class="container">
                      <div class="row">
                        ...
                        >
                          ...
                          >
                            Created a web application using Django a python based framework where user can sell and buy used products.
                            Designed front-end of the application using Foundation 6. Containerize the front-end and back-end
                            of the application in docker and deployed the application on Google Cloud Platform (GCP).
                          </p>
                        </div>
                        <div
                          class="col-2"
